...
class OsMonoProfilePublisher(Node):
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(OsMonoProfile, 'os_mono_omniscan/pingprofile', 10)
    ...
    def timer_callback(self):
        ...
        msg.pwr_results = [uniform(msg.min_pwr_db, msg.max_pwr_db) for _ in range(msg.num_results)]
