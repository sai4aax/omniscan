...
asciiMsgs = [definitions.COMMON_GENERAL_NACK, definitions.COMMON_GENERAL_ASCII_TEXT]
variable_msgs = [definitions.OMNISCAN450_GENERAL_JSON_WRAPPER, definitions.OMNISCAN450_GET_OS_MONO_PROFILE, ]
    ...
    def __init__(self, msg_id=0, msg_data=None):
        ...
        # (for packing + transmitting)
            ...
            try:
                ...
                ## Number of bytes in the message payload, it is same as below one 
                ## self.payload_length = some value
